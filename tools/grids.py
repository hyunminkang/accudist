...
REFERENCE_VALUES = {
    ...
    "nu": [0.0, 0.5, 2.0, 5.0],
    "a": [0.01, 0.05, 0.1, 0.2, 0.5, 0.75, 1.0, 1.5, 2.0, 3.0, 5.0, 8.0, 10.0, 20.0, 100.0],
    "b": [0.02, 0.08, 0.2, 0.4, 0.8, 1.0, 1.2, 2.0, 4.0, 6.0, 9.0, 15.0, 30.0, 80.0, 200.0, 1e3],
    "deriv": [0.0, 1.0, 2.0, 3.0], "digits": [-2.0, 0.0, 3.0, 10.0],
    "logx": [-1e3, -100.0, -50.0, -20.0, -10.0, -5.0, -2.0, -1.0, -0.5, 0.0, 0.5, 1.0, 2.0, 5.0, 10.0, 20.0, 50.0, 100.0, 500.0, 1e3],
    "logy": [-2e3, -200.0, -80.0, -30.0, -15.0, -8.0, -3.0, -1.5, -0.75, -0.1, 0.25, 0.75, 1.5, 3.0, 8.0, 15.0, 30.0, 80.0, 200.0, 800.0, 2e3],
