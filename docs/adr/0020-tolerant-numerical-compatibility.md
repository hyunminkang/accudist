...
tolerance of 1% and an absolute tolerance of zero. This covers the measured Windows
differences while retaining sensitivity for results close to zero. NaNs compare
semantically, and unmatched infinities continue to fail.
